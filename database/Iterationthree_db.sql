CREATE TABLE if NOT EXISTS `route`(
    ...
    difficulty_level ENUM('Easy', 'Medium', 'Adventure') NOT NULL COMMENT 'Route difficulty level',

    distance_m DECIMAL(8,2) NOT NULL COMMENT 'Estimated route distance in meters',

    estimated_time_sec INT UNSIGNED NOT NULL COMMENT 'Estimated route completion time in seconds',
    ...
    task_cluster_count INT UNSIGNED COMMENT 'Number of task clusters used to generate this route',
